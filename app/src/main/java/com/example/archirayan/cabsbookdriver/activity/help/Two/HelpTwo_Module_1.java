...
public class HelpTwo_Module_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_two__module_1);
        ...
        img_back_helpactivity2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HelpTwo_Module_1.this,EarningsHelpTwo.class));
            }
        });
    }
}
