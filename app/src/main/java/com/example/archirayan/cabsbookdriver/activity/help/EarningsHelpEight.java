...
public class EarningsHelpEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_earnings_help_fight);
        ...
        img_back_helpactivity2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EarningsHelpEight.this,EarningsHelp.class));
            }
        });
    }
}
