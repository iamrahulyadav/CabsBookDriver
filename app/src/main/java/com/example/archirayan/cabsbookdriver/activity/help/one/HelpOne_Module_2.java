...
public class HelpOne_Module_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_one__module_2);
        ...
        img_back_helpactivity2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(HelpOne_Module_2.this,EarningsHelpOne.class));
            }
        });
    }
}
