...
public class EarningsHelpSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_earnings_help_six);
        ...
        img_back_helpactivity2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EarningsHelpSix.this,EarningsHelp.class));
            }
        });
    }
}
