...
import com.example.archirayan.cabsbookdriver.Utils.PrefManager;
...
public class DriverShareMytrripSetupDetail extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      /*  viewPager = (ViewPager) findViewById(R.id.viewPager);
        ...
        dotscount = viewPagerAdapter.getCount();
         txt_nextview = findViewById(R.id.txt_nextview);
    ...
    private void launchHomeScreen()
    {
        ...
        startActivity(new Intent(DriverShareMytrripSetupDetail.this, DriverShareMytrripcontactDetail.class));
        finish();
    }
